...
#define GAZE_ESTIMATION_MODEL "./gaze-estimation-adas-0002.xml"
#define FACE_DETECTION_MODEL "./face-detection-adas-0001.xml"
#define HEAD_POSE_MODEL "./head-pose-estimation-adas-0001.xml"
#define FACIAL_LANDMARKS_MODEL "./facial-landmarks-35-adas-0002.xml"
#include <functional>
#include <iostream>
#include <fstream>
#include <random>
...
void writeEmotion(const cv::Mat& image, std::string nameEmotion) {
    ...
    double fontScale = 4 * frameHeight / 640;
...
int main(int argc, char *argv[]) {
    try {
        ...
        std::ofstream of;
        of.open("results.csv");
        of << "Remebering sounds" << ";" << ";" <<"Internal dialogue" << ";" << ";" << "Access feelings(lie)" << ";" << ";" << "Construct sounds(lie)" << ";" << ";" << "Construct images(lie)" << ";" << ";" << "Remebering images";
        of << std::endl;
